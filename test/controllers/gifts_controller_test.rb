...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference("Gift.count") do
      post gifts_url, params: { gift: { desc: @gift.desc, favorited_user_id: @gift.favorited_user_id, price: @gift.price, title: @gift.title, url: @gift.url, user_id: @gift.user_id } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { desc: @gift.desc, favorited_user_id: @gift.favorited_user_id, price: @gift.price, title: @gift.title, url: @gift.url, user_id: @gift.user_id } }
